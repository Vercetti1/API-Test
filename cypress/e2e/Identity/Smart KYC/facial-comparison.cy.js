...
describe('Smart KYC - Facial Comparison API', () => {
  const url = 'https://dev-core-api-v2.blusalt.net/api/smart-kyc/facial-comparison';
  ...
  it('should return facial comparison data for valid images', () => {
    cy.request({
      method: 'POST',
      url,
