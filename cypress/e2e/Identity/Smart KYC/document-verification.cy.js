...
describe('Smart KYC - Document Verification API', () => {
  const url = 'https://dev-core-api-v2.blusalt.net/api/smart-kyc/document-verification';
  ...
  it('should return document verification data for valid images', () => {
    cy.request({
      method: 'POST',
      url,
