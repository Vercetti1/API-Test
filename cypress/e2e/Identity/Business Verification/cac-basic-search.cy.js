...
describe('CAC Basic Search API', () => {
  const url = 'https://dev-core-api-v2.blusalt.net/api/businesses/cac-basic-search';

  const validPayload = {
    registrationNumber: "RC00000000"
  };

  it('should return CAC basic search results successfully', () => {
    cy.request({
      method: 'POST',
      url,
